...
@RoutePage()
class JoinInsertStudentIdPage extends StatefulWidget
    implements AutoRouteWrapper {
  const JoinInsertStudentIdPage({super.key, required this.classCode});
  ...
  Widget wrappedRoute(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<JoinCubit>()..onClassCodeChanged(classCode),
  ...
  @override
  State<JoinInsertStudentIdPage> createState() => JoinPageState();
}

class JoinPageState extends State<JoinInsertStudentIdPage> {
            ...
            child: CustomScrollView(
              slivers: [
                SliverAppBar.large(
                  ...
                  elevation: 0,
                  expandedHeight: 200,
                  title: const Text('Satu langkah lagi!'),
                ),
                SliverToBoxAdapter(
                  child: Card(
